...
`remoteUserID`  |  Required  | String (256 bytes) or Object| It is generated by the origin server.
...
-----------  | ----------- | -------- | ----------
`pcObject`  | Required  | Object | _PeerConnection_ object.
`userID`  | Required  | String (256 bytes) or Object | It is generated by the origin server.
`conferenceID`  | Required | String (256 bytes)| It is generated by the origin server.
...
<li> `userID` is `localUserID` for local SDPs and `remoteUserID` for remote SDPs.</li>
...
`pcObject`  | Required  |  Object | _PeerConnection_ object.
`conferenceID`   | Required  | String (256 bytes) | It is generated by the origin server.
`newUserID`  |  Required  | String (256 bytes) or Object| It is generated by the origin server.
